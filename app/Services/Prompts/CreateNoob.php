...
class CreateNoob
{
    public $prompt = "*Generate a detailed NPC card for a 2D top-down survival game set on {world_story}. The NPC should have unique attributes and a compelling backstory. Ensure realism.*
